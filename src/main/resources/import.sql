...
INSERT INTO movies(movie_id, description, media_path, release_year, movie_title) VALUES(nextval('movie_sequence'), 'After discovering a mysterious artifact buried beneath the Lunar surface, mankind sets off on a quest to find its origins with help from intelligent supercomputer H.A.L. 9000.', '2001.jpeg', '1968', '2001: A Space Odyssey');

INSERT INTO movies(movie_id, description, media_path, release_year, movie_title) VALUES(nextval('movie_sequence'), 'A story of family, religion, hatred, oil and madness, focusing on a turn-of-the-century prospector in the early days of the business.', 'twbb.jpg', '2007', 'There Will Be Blood');
